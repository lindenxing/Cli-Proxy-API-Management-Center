...
// FORK-REMOVED: sponsor quick-start imports
...
export function MainLayout() {
  ...
  // FORK-REMOVED: config subscription only used by sponsor quick-start nav
  ...
  // FORK-REMOVED: sponsor quick-start nav item
